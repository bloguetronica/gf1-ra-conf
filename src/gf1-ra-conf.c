/* GF1 Rev. A Configuration Program - Version 2.0 for Debian Linux
...
int main(int argc, char **argv)
{
    ...
    {
        fprintf(stderr, "Error: Missing argument.\nUsage: gf1-ra-conf SERIALNUMBER\n");
...
{
    unsigned char control_buf_out[64] = {
        0x1C, 0x03, 0x47, 0x00, 0x46, 0x00, 0x31, 0x00,  // GF1-A0xxxxxx
        0x2D, 0x00, 0x41, 0x00, 0x30, 0x00,
        serial[0], 0x00,
        serial[1], 0x00,
        serial[2], 0x00,
        serial[3], 0x00,
